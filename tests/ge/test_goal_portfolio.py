...
def _create_project_on_program(client, program_id: str, *, pm_user_id: str = U_PM, owner_user_id: str = "910") -> dict:
    resp = client.post(
        "/api/v1/ge/projects",
...
def _create_sub_and_program(client, company_id: str, dept_id: str, *, owner: str = "910") -> tuple[dict, dict]:
    sub = client.post(
